  ...
  return (
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.drawer} onClick={(e) => e.stopPropagation()}>
        ...
        {/* Client Workspace and Client Users are not yet backed by the API.
            They were removed rather than left as local-state mocks that
            silently discard the user's input. See the Client Workspace
            backend build. */}
