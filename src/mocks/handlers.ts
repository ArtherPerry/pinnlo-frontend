 ...
 // ── Posts ─────────────────────────────────────────────────────
  http.get(`${BASE}/api/posts`, ({ request }) => {
    ...
    const allPosts = [
      ...
      {
        id:          'post-006',
        content:     'Introducing our new signature latte ☕ Rich, smooth, and made with locally-sourced beans.',
        status:      'PENDING_CLIENT',
        scheduledAt: new Date(Date.now() + 259200000).toISOString(),
        publishedAt: null,
        platforms:   ['FACEBOOK', 'INSTAGRAM'],
        targets:     [
          { platform: 'FACEBOOK',  status: 'PENDING_CLIENT' },
          { platform: 'INSTAGRAM', status: 'PENDING_CLIENT' },
        ],
        approval:    { id: 'apr-003', status: 'APPROVED', approvedBy: 'Nattawut C.', decidedAt: new Date(Date.now() - 3600000).toISOString() },
        media:       [],
        labels:      ['product'],
        clientId:    'client-001',
        clientName:  'Somjai Coffee',
      ...
      {
        id:          'post-007',
        content:     'Weekend special: buy one get one free on all pastries! 🥐',
        status:      'CHANGES_REQUESTED',
        scheduledAt: new Date(Date.now() + 432000000).toISOString(),
        publishedAt: null,
        platforms:   ['FACEBOOK'],
        targets:     [{ platform: 'FACEBOOK', status: 'CHANGES_REQUESTED' }],
        approval:    {
          id: 'apr-004',
          status: 'APPROVED',
          approvedBy: 'Nattawut C.',
          decidedAt: new Date(Date.now() - 7200000).toISOString(),
          clientComment: 'Can we make it 15% off instead of BOGO? And please mention our new almond croissant.',
          clientDecidedAt: new Date(Date.now() - 1800000).toISOString(),
        },
        media:       [],
        labels:      ['promotion', 'food'],
        clientId:    'client-001',
